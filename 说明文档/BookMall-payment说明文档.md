...
数据库连接配置在 [nacos-config/payment.yaml](D:/workspace_idea/BookMall/nacos-config/payment.yaml) 中维护。
...
- 增加支付中状态
- 使用 MQ 或 Seata 替换当前同步 Feign 的跨服务一致性方案
- 增加支付流水对账和退款流程
